  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-6 my-3">
        ...
        <p className="text-muted">Our Organization deals in Medicine Notifications.Our Organization provides Notification for its user so that any user never forget medicine name or dose or timings to consume and enables its user to store data of medicine and medical healthcare online</p>
